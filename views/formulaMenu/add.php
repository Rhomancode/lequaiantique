...
<form class="form" id="form" action="" method="post">
    ...
    <div class="formGroup">
        <input type="text" name="name" id="name" class="formInput" placeholder="Nom de la formule" required="required">
    </div>
    <div class="formGroup">
        <button type="submit" class="formBtn">Ajouter</button>
    </div>
    <div class="formGroup">
        <a class="addButton" href='/formules'>Retour à la liste des formules de menus</a>
    </div>
</form>
